...
\begin{frame}{Proving program transformations correct}
  ...
  \item Coming back on STLC:
    ...
    \begin{mathpar}
      \inferrule{ }{x,\tau_1,\tau_2 \in \Gamma \vdash Var \tau_1 \equiv Var \tau_2}
      \and
      \inferrule{\Gamma \vdash e_1 \equiv e'_1 \and \Gamma \vdash e_1 \equiv e'_1}
      {\Gamma \vdash App e_1 e_2 \equiv App e'_1 e'_2}
      \\
      \inferrule{\forall x \tau_1 \tau_2, (x,\tau_1,\tau_2), 
        \Gamma \vdash e_1 \tau_1 \equiv e'_1 \tau_2}
      {\Gamma \vdash Abs e_1 \equiv App e'_1}
